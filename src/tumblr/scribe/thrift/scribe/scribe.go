...
func (p *LogArgs) ReadField1(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  for _i17:= 0; _i17 < _size13; _i17++ {
    ...
    if err21 != nil { return thrift.NewTProtocolExceptionReadStruct("_elem18LogEntry", err21); }
...
func (p *LogArgs) WriteField1(oprot thrift.TProtocol) (err thrift.TProtocolException) {
  if p.Messages != nil {
    ...
    if err != nil { return thrift.NewTProtocolExceptionWriteField(1, "messages", p.ThriftName(), err); }
    ...
    for Iter22 := range p.Messages.Iter() {
      ...
      if err != nil { return thrift.NewTProtocolExceptionWriteStruct("LogEntry", err); }
    }
...
func (p *LogResult) ReadField0(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err25 != nil { return thrift.NewTProtocolExceptionReadField(0, "success", p.ThriftName(), err25); }
